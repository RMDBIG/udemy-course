let js ='amazing';
      ...
      let myfirstName="joan"
      let myfirstJob="programmer"
      let mycurrentJob="forex trader"
      ...
      console.log(2**3);
      This means 2 to the power of 3 that is 2 raised to power 3
      that is 2*2*2=8
...
console.log(`string with \n\
      ...
      const Kayode = `I'm ${firstName} a ${business} attending ${institution}`;
...
if(BMIMark > BMIJohn) {
     ...
     const myYear = '2000';
     console.log(Number(myYear));
     console.log(myYear + 20);
...
const age = '18';
if(18===18){
      console.log(`let it be defined : D (strictly)`)
} else {
